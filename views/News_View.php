...
<?php
    ...
    {//выводит сообщения из массива $arr
        ...
        foreach ($this->array as $item=>$k) {
            ...
            $s .= '<div class="button float_r"><a href="blog_post.html" class="more">Read more</a></div>';
            $s .= '<div class="cleaner"></div>';
...
?>
        ...
        <div id="templatemo_footer_wrapper">
            <div id="templatemo_footer">
                ...
                <a href="http://bayguzin.ru/" target="_parent">Website Templates</a> by <a
                    href="http://bayguzin.ru/" target="_parent">Free CSS Templates</a>
